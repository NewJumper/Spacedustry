...
public class ConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> MOLYBDENITE_TARGET_LIST = Suppliers.memoize(() -> List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, SpacedustryBlocks.MOLYBDENITE_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, SpacedustryBlocks.DEEPSLATE_MOLYBDENITE_ORE.get().defaultBlockState())));
    public static final Supplier<List<OreConfiguration.TargetBlockState>> NICKEL_TARGET_LIST = Suppliers.memoize(() -> List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, SpacedustryBlocks.NICKEL_ORE.get().defaultBlockState()), OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, SpacedustryBlocks.DEEPSLATE_NICKEL_ORE.get().defaultBlockState())));
    public static final Supplier<List<OreConfiguration.TargetBlockState>> SILICON_TARGET_LIST = Suppliers.memoize(() -> List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, SpacedustryBlocks.SILICON_ORE.get().defaultBlockState())));
