...
public class SpacedustryBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(SpacedustryBlocks.DEBRIS_ROCKS.get(), SpacedustryBlocks.SPACE_STONE.get(), SpacedustryBlocks.CONSTRUCTOR.get(), SpacedustryBlocks.GAS_CONDENSER.get(), SpacedustryBlocks.MANUFACTURER.get(), SpacedustryBlocks.ROCKET_ASSEMBLER.get())
