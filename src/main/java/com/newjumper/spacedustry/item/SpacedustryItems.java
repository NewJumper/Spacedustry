...
public class SpacedustryItems {
    ...
    public static final RegistryObject<Item> GAS_CONTAINER = ITEMS.register("gas_container", () -> new GasContainerItem(new Item.Properties().tab(SpacedustryCreative.SPACEDUSTRY).stacksTo(1)));
}
