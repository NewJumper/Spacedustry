...
public class SpacedustryItems {
    ...
    public static final RegistryObject<Item> MOLYBDENITE = ITEMS.register("molybdenite", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> BULNITE_ALLOY = ITEMS.register("bulnite_alloy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> COBALT_ALLOY = ITEMS.register("cobalt_alloy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DURALUMIN_ALLOY = ITEMS.register("duralumin_alloy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> STEEL_ALLOY = ITEMS.register("steel_alloy", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> SUPER_ALLOY = ITEMS.register("super_alloy", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> COMPOSITE_BUILDER = ITEMS.register("composite_builder", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> AEROGRADE_PLATE = ITEMS.register("aerograde_plate", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> BULNITE_PLATE = ITEMS.register("bulnite_plate", () -> new Item(new Item.Properties()));

    public static final RegistryObject<Item> GAS_CONTAINER = ITEMS.register("gas_container", () -> new Item(new Item.Properties().stacksTo(1)));
}
