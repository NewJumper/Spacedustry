...
public class ConstructingRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId) {
        ...
        consumer.accept(new ConstructingRecipeBuilder.Result(recipeId, this.result, this.ingredients, this.count, this.experience, this.time, this.advancement, recipeId.withPrefix("recipes/" + RecipeCategory.MISC.getFolderName() + "/")));
    }
