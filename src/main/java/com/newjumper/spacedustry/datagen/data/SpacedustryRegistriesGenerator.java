...
import com.newjumper.spacedustry.world.BiomeModifiers;
...
public class SpacedustryRegistriesGenerator extends DatapackBuiltinEntriesProvider {
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder().add(ForgeRegistries.Keys.BIOME_MODIFIERS, BiomeModifiers::bootstrap).add(Registries.CONFIGURED_FEATURE, ConfiguredFeatures::bootstrap).add(Registries.DIMENSION_TYPE, PlanetDimensions::bootstrap).add(Registries.PLACED_FEATURE, PlacedFeatures::bootstrap);
